                                  ...
                                  <tbody className="divide-y divide-[#1B2D50]/[0.04]">
                                    {mealLogs.map((item) => (
                                      <tr key={item.id} className="group">
                                        ...
                                        <td className="px-3 py-2 text-right text-[#1B2D50]">
                                          {editingId === item.id ? (
                                            <input
                                              type="number"
                                              ...
                                              placeholder="0"
                                              className="px-2 py-1 border border-[#1A7BFF]/30 rounded text-xs bg-white w-16 text-right"
                                            />
                                          ) : (
                                            item.calories
                                          )}
                                        </td>
                                        <td className="px-3 py-2 text-right text-[#1A7BFF] hidden sm:table-cell">
                                          {editingId === item.id ? (
                                            <input
                                              type="number"
                                              ...
                                              placeholder="0"
                                              className="px-2 py-1 border border-[#1A7BFF]/30 rounded text-xs bg-white w-14 text-right"
                                            />
                                          ) : (
                                            `${item.protein}g`
                                          )}
                                        </td>
                                        <td className="px-3 py-2 text-right text-[#F76B16] hidden sm:table-cell">
                                          {editingId === item.id ? (
                                            <input
                                              type="number"
                                        ...
                                        <td className="px-3 py-2 text-right text-[#64748B] hidden sm:table-cell">
                                          {editingId === item.id ? (
                                            <input
                                              type="number"
                                              value={editForm.fats}
                                          ...
                                          {editingId === item.id ? (
                                            <div className="flex gap-1 justify-end">
                                              ...
                                              <button
                                                ...
                                                className="text-[#64748B] hover:text-[#1B2D50] font-semibold text-xs"
                                              >
                                                Cancel
                                              </button>
                                            </div>
                                            ...
                                            <div className="flex gap-2 justify-end opacity-0 group-hover:opacity-100 transition-opacity duration-150">
                                              <button
                                                ...
                                                className="text-[#1A7BFF] hover:text-[#0F5FE0] text-xs font-semibold"
                                              >
                                                Edit
                                              </button>
                                              <button
